...
public class PersonIT extends CollectionSpaceIT {
	public static final Logger logger = Logger.getLogger(PersonIT.class);
	...
	public void testAllFields() throws SaveFailedException {
		testAllFields(CollectionSpacePage.PERSON);
	}
}
