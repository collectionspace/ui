...
public class ObjectExitIT extends CollectionSpaceIT {
	public static final Logger logger = Logger.getLogger(ObjectExitIT.class);
	...
	public void testAllFields() throws SaveFailedException {
		testAllFields(CollectionSpacePage.OBJECTEXIT);
	}
}
