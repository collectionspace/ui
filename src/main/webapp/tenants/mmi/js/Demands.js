...
(function ($, fluid) {
    ...
    cspace.includeDemands = function () {
		...
		fluid.demands("remove", ["cspace.recordEditor", "work"], {
        ...
        fluid.demands("cspace.workStructuredDate", ["cspace.repeatableImpl", "cspace.makeRepeatable", "cspace.recordEditor"], {
            container: "{arguments}.0",
            mergeAllOptions: [{
                applier: "{repeatableImpl}.applier",
                model: "{repeatableImpl}.model",
                ...
                listeners: {
                    repeatableOnRefreshView: "{workStructuredDate}.events.removeListeners.fire",
                    recordEditorOnRenderTree: "{workStructuredDate}.events.removeListeners.fire"
                }
            }, "{arguments}.1"]
        });
        ...
        fluid.demands("cspace.personStructuredDate", ["cspace.repeatableImpl", "cspace.makeRepeatable", "cspace.recordEditor"], {
            container: "{arguments}.0",
            mergeAllOptions: [{
                applier: "{repeatableImpl}.applier",
                model: "{repeatableImpl}.model",
                ...
                listeners: {
                    repeatableOnRefreshView: "{personStructuredDate}.events.removeListeners.fire",
                    recordEditorOnRenderTree: "{personStructuredDate}.events.removeListeners.fire"
                }
            }, "{arguments}.1"]
        });
        ...
        fluid.demands("cspace.catalogingStructuredDate", ["cspace.repeatableImpl", "cspace.makeRepeatable", "cspace.recordEditor"], {
            container: "{arguments}.0",
            mergeAllOptions: [{
                applier: "{repeatableImpl}.applier",
                model: "{repeatableImpl}.model",
                ...
                listeners: {
                    repeatableOnRefreshView: "{catalogingStructuredDate}.events.removeListeners.fire",
                    recordEditorOnRenderTree: "{catalogingStructuredDate}.events.removeListeners.fire"
                }
            }, "{arguments}.1"]
        });
