...
(function ($, fluid) {
    ...
    fluid.defaults("cspace.workStructuredDate", {
        ...
        postInitFunction: "cspace.workStructuredDate.postInitFunction",
        finalInitFunction: "cspace.workStructuredDate.finalInitFunction",
        selectors: {
            popupContainer: ".csc-structuredDate-popup-container"
        },
        styles: {
        ...
        invokers: {
            showPopup: {
                funcName: "cspace.workStructuredDate.showPopup",
                args: "{workStructuredDate}"
            },
            hidePopup: {
                funcName: "cspace.workStructuredDate.hidePopup",
                args: "{workStructuredDate}"
            }
        },
        // Sub-components of this component are declared here.
        ...
        components: {
            popup: {
                type: "cspace.workStructuredDate.popup",
                container: "{workStructuredDate}.popupContainer",
                options: {
                    model: "{workStructuredDate}.model",
                    applier: "{workStructuredDate}.applier",
                    elPaths: "{workStructuredDate}.options.elPaths",
                    root: "{workStructuredDate}.options.root",
                    events: {
                        removeListeners: "{workStructuredDate}.events.removeListeners"
                    }
                }
        ...
        listeners: {
            removeListeners: {
                listener: "{workStructuredDate}.removeApplierListeners"
            }
        }
    });
    ...
    fluid.defaults("cspace.catalogingStructuredDate", {
        ...
        postInitFunction: "cspace.catalogingStructuredDate.postInitFunction",
        finalInitFunction: "cspace.catalogingStructuredDate.finalInitFunction",
        selectors: {
            popupContainer: ".csc-structuredDate-popup-container"
        },
        styles: {
        ...
        invokers: {
            showPopup: {
                funcName: "cspace.catalogingStructuredDate.showPopup",
                args: "{catalogingStructuredDate}"
            },
            hidePopup: {
                funcName: "cspace.catalogingStructuredDate.hidePopup",
                args: "{catalogingStructuredDate}"
            }
        },
        // Sub-components of this component are declared here.
        ...
        components: {
            popup: {
                type: "cspace.catalogingStructuredDate.popup",
                container: "{catalogingStructuredDate}.popupContainer",
                options: {
                    model: "{catalogingStructuredDate}.model",
                    applier: "{catalogingStructuredDate}.applier",
                    elPaths: "{catalogingStructuredDate}.options.elPaths",
                    root: "{catalogingStructuredDate}.options.root",
                    events: {
                        removeListeners: "{catalogingStructuredDate}.events.removeListeners"
                    }
                }
        ...
        listeners: {
            removeListeners: {
                listener: "{catalogingStructuredDate}.removeApplierListeners"
            }
        }
    });
    ...
    fluid.defaults("cspace.personStructuredDate", {
        ...
        postInitFunction: "cspace.personStructuredDate.postInitFunction",
        finalInitFunction: "cspace.personStructuredDate.finalInitFunction",
        selectors: {
            popupContainer: ".csc-structuredDate-popup-container"
        },
        styles: {
        ...
        invokers: {
            showPopup: {
                funcName: "cspace.personStructuredDate.showPopup",
                args: "{personStructuredDate}"
            },
            hidePopup: {
                funcName: "cspace.personStructuredDate.hidePopup",
                args: "{personStructuredDate}"
            }
        },
        // Sub-components of this component are declared here.
        ...
        components: {
            popup: {
                type: "cspace.personStructuredDate.popup",
                container: "{personStructuredDate}.popupContainer",
                options: {
                    model: "{personStructuredDate}.model",
                    applier: "{personStructuredDate}.applier",
                    elPaths: "{personStructuredDate}.options.elPaths",
                    root: "{personStructuredDate}.options.root",
                    events: {
                        removeListeners: "{personStructuredDate}.events.removeListeners"
                    }
                }
        ...
        listeners: {
            removeListeners: {
                listener: "{personStructuredDate}.removeApplierListeners"
            }
        }
    });
    ...
    cspace.workStructuredDate.preInit = function (that) {
        that.removeApplierListeners = function () {
            that.applier.modelChanged.removeListener("elPath-" + that.id);
        };
    };

    cspace.catalogingStructuredDate.preInit = function (that) {
        that.removeApplierListeners = function () {
            that.applier.modelChanged.removeListener("elPath-" + that.id);
        };
    };

    cspace.personStructuredDate.preInit = function (that) {
        that.removeApplierListeners = function () {
            that.applier.modelChanged.removeListener("elPath-" + that.id);
        };
    };
    ...
    cspace.workStructuredDate.finalInitFunction = function (that) {
        // Dismiss the structured date popup by pressing the ESC key
        that.union.keyup(function (event) {
            if (cspace.util.keyCode(event) === $.ui.keyCode.ESCAPE) {
                that.container.focus();
    ...
    cspace.catalogingStructuredDate.finalInitFunction = function (that) {
        // Dismiss the structured date popup by pressing the ESC key
        that.union.keyup(function (event) {
            if (cspace.util.keyCode(event) === $.ui.keyCode.ESCAPE) {
                that.container.focus();
    ...
    cspace.personStructuredDate.finalInitFunction = function (that) {
        // Dismiss the structured date popup by pressing the ESC key
        that.union.keyup(function (event) {
            if (cspace.util.keyCode(event) === $.ui.keyCode.ESCAPE) {
                that.container.focus();
    ...
    cspace.workStructuredDate.postInitFunction = function (that) {
        that.container.addClass(that.options.styles.structuredDate);
        // Create a container element and attach it to the DOM.
        // The structured date popup will later be inserted within this container.
        that.popupContainer =
    ...
    cspace.catalogingStructuredDate.postInitFunction = function (that) {
        that.container.addClass(that.options.styles.structuredDate);
        // Create a container element and attach it to the DOM.
        // The structured date popup will later be inserted within this container.
        that.popupContainer =
    ...
    cspace.personStructuredDate.postInitFunction = function (that) {
        that.container.addClass(that.options.styles.structuredDate);
        // Create a container element and attach it to the DOM.
        // The structured date popup will later be inserted within this container.
        that.popupContainer =
    ...
    fluid.defaults("cspace.workStructuredDate.popup", {
        ...
        protoTree: {},
        getProtoTree: "cspace.workStructuredDate.popup.getProtoTree",
        parentBundle: "{globalBundle}",
        selectorsToIgnore: ["popup"],
        selectors: {
            popup: ".csc-structuredDate-popup",
        ...
        invokers: {
            resolveFullElPath: {
                funcName: "cspace.workStructuredDate.popup.resolveFullElPath",
                args: ["{popup}.composeElPath", "{arguments}.0"]
            },
            composeElPath: {
                funcName: "cspace.workStructuredDate.popup.composeElPath",
                args: ["{popup}.options.elPaths", "{popup}.options.root", "{arguments}.0"]
            },
            composeRootElPath: {
                funcName: "cspace.workStructuredDate.popup.composeRootElPath",
                args: ["{popup}.options.elPaths", "{popup}.options.root"]
            },
            updateScalarValues: {
    ...
    fluid.defaults("cspace.catalogingStructuredDate.popup", {
        finalInitFunction: "cspace.catalogingStructuredDate.popup.finalInitFunction",
        preInitFunction: "cspace.catalogingStructuredDate.popup.preInit",
        gradeNames: ["fluid.rendererComponent", "autoInit"],
        // When merging models between component and sub-component,
        // the "preserve" policy will share the original model object,
        // rather than using an independent copy of that object for each.
        ...
        protoTree: {},
        getProtoTree: "cspace.catalogingStructuredDate.popup.getProtoTree",
        parentBundle: "{globalBundle}",
        selectorsToIgnore: ["popup"],
        selectors: {
            popup: ".csc-structuredDate-popup",
        ...
        invokers: {
            resolveFullElPath: {
                funcName: "cspace.catalogingStructuredDate.popup.resolveFullElPath",
                args: ["{popup}.composeElPath", "{arguments}.0"]
            },
            composeElPath: {
                funcName: "cspace.catalogingStructuredDate.popup.composeElPath",
                args: ["{popup}.options.elPaths", "{popup}.options.root", "{arguments}.0"]
            },
            composeRootElPath: {
                funcName: "cspace.catalogingStructuredDate.popup.composeRootElPath",
                args: ["{popup}.options.elPaths", "{popup}.options.root"]
            },
            updateScalarValues: {
    ...
    fluid.defaults("cspace.personStructuredDate.popup", {
        ...
        preInitFunction: "cspace.personStructuredDate.popup.preInit",
        gradeNames: ["fluid.rendererComponent", "autoInit"],
        // When merging models between component and sub-component,
        // the "preserve" policy will share the original model object,
        // rather than using an independent copy of that object for each.
        ...
        protoTree: {},
        getProtoTree: "cspace.personStructuredDate.popup.getProtoTree",
        parentBundle: "{globalBundle}",
        selectorsToIgnore: ["popup"],
        selectors: {
            popup: ".csc-structuredDate-popup",
        ...
        resources: {
            template: cspace.resourceSpecExpander({
                fetchClass: "slowTemplate",
                url: "%webapp/html/components/StructuredDate-person.html",
                options: {
                    dataType: "html"
                }
            })
        ...
        invokers: {
            resolveFullElPath: {
                funcName: "cspace.personStructuredDate.popup.resolveFullElPath",
                args: ["{popup}.composeElPath", "{arguments}.0"]
            },
            composeElPath: {
                funcName: "cspace.personStructuredDate.popup.composeElPath",
                args: ["{popup}.options.elPaths", "{popup}.options.root", "{arguments}.0"]
            },
            composeRootElPath: {
                funcName: "cspace.personStructuredDate.popup.composeRootElPath",
                args: ["{popup}.options.elPaths", "{popup}.options.root"]
            },
            updateScalarValues: {
    ...
    cspace.workStructuredDate.popup.composeRootElPath = function (elPaths, root) {
        var path = fluid.find(elPaths, function(elPath) {
            var segs = elPath.split(".");
            return segs.slice(0, segs.length - 1).join(".");
        });
    ...
    cspace.catalogingStructuredDate.popup.composeRootElPath = function (elPaths, root) {
        var path = fluid.find(elPaths, function(elPath) {
            var segs = elPath.split(".");
            return segs.slice(0, segs.length - 1).join(".");
        });
    ...
    cspace.personStructuredDate.popup.composeRootElPath = function (elPaths, root) {
        var path = fluid.find(elPaths, function(elPath) {
            var segs = elPath.split(".");
            return segs.slice(0, segs.length - 1).join(".");
        });
    ...
    cspace.workStructuredDate.popup.resolveFullElPath = function (composeElPath, key) {
        return "${" + composeElPath(key) + "}";
    };

    cspace.catalogingStructuredDate.popup.resolveFullElPath = function (composeElPath, key) {
        return "${" + composeElPath(key) + "}";
    };
    ...
    cspace.workStructuredDate.popup.composeElPath = function (elPaths, root, key) {
        return cspace.util.composeSegments(root, elPaths[key]);
    };
    ...
    cspace.workStructuredDate.popup.getProtoTree = function (that) {
        return {
            dateEarliestSingleQualifier: {
                optionnames: [
                    "+/-",
    ...
    cspace.catalogingStructuredDate.popup.getProtoTree = function (that) {
        return {
            dateEarliestSingleQualifier: {
                optionnames: [
                    "+/-",
    ...
    cspace.personStructuredDate.popup.getProtoTree = function (that) {
        return {
            dateEarliestSingleQualifier: {
                optionnames: [
                    "+/-",
